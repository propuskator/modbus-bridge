...
const conf = require('./../../etc/logger.config');
...
const DEFAULT_LEVEL   = conf.VERBOSE || LEVELS.INFO;
const IS_PLAIN_FORMAT = conf.LOG_FORMAT === 'plain';
